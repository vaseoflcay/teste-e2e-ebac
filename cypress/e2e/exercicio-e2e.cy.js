...
context('Exercicio - Testes End-to-end - Fluxo de pedido', () => {
  ...
  it('Deve fazer um pedido na loja Ebac Shop de ponta a ponta', () => {
    ...
    it('Deve buscar e adicionar o primeiro produto no carrinho',() => {//optei por page objects para selecionar produto
        ...
        produtosPage.addProdutoCarrinho4('M','Blue', qtd)
    ...
    it('Deve buscar e adicionar o segundo produto no carrinho',() => {//optei por page objects para selecionar produto
        ...
        produtosPage.addProdutoCarrinho4('XL','Black', qtd)
        cy.get('.woocommerce-message').should('contain', qtd + ' × “Vulcan Weightlifting Tank” foram adicionados no seu carrinho. ')
    ...
    it('Deve buscar e adicionar o terceiro produto no carrinho',() => {//optei por page objects para selecionar produto
        ...
        produtosPage.addProdutoCarrinho4('32','Red', qtd)
        cy.get('.woocommerce-message').should('contain', qtd + ' × “Cronus Yoga Pant” foram adicionados no seu carrinho. ')
    ...
    it('Deve buscar e adicionar o quarto produto no carrinho',() => {//optei por page objects para selecionar produto
       let qtd=4
        ...
        produtosPage.addProdutoCarrinho4('36','Green', qtd)
        cy.get('.woocommerce-message').should('contain', qtd + ' × “Sol Active Short” foram adicionados no seu carrinho. ')
